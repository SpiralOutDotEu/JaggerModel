...
//const MODEL_URL = tf.io.fileSystem("./assets/model.json");
const MODEL_URL = "http://localhost:8080/web_model/model.json";
...
export default {
  ...
  methods: {
    ...
    async detectObjects() {
      ...
      const tf4d = tf.tensor4d(Array.from(resized.dataSync()), [
        1,
        300,
        300,
        3
